...
public class UnitTest1
{
    ...
    public void PurchaseParkingPass()
    {
        ...
        //Act
        string result = parkingLot.ParkingLotRepository.LeaseParkingSpace(type, licensePlate, parkingLot.ParkingSpaceList, false);

        //Assert
        Assert.Equal($"Parking space leased for: {parkingSpace.LicensePlate}\nYour hourly rate is: {parkingSpace.Price:C}\nYour parking space ID is: {parkingSpace.Id}\nCarWash: Bought for vehicle: {parkingSpace.LicensePlate}", result);
    }
}
